...
System.register(["@angular/core"], function (exports_1, context_1) {
    ...
    var core_1, nextId, UserServiceConfig, UserService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {// Crazy copy of the app/user.service
            // Proves that UserService is an app-wide singleton and only instantiated once
            // IFF shared.module follows the `forRoot` pattern
            //
            // If it didn't, a new instance of UserService would be created
            // after each lazy load and the userName would double up.
            nextId = 1;
            UserServiceConfig = (function () {
                function UserServiceConfig() {
                    this.userName = 'Carlos Santana';
                }
                return UserServiceConfig;
            }());
            exports_1("UserServiceConfig", UserServiceConfig);
            UserService = (function () {
                function UserService(config) {
                    this.id = nextId++;
                    this._userName = 'Harry  Potter';
                    if (config) {
